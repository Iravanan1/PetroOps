...
exports.HandwritingIsolationEngine = void 0;
class HandwritingIsolationEngine {
    /**
     * Identifies overlapping handwriting blobs that break outside of table cells.
     */
    static isolateHandwritingMask(imageBlobData) {
...
exports.HandwritingIsolationEngine = HandwritingIsolationEngine;
