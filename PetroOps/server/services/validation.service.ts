import { ShiftExtraction, ShiftRecord, NozzleReading } from "../../src/types/index.js";
import { ReconciliationEngine } from "../../src/lib/ReconciliationEngine.js";
...
export class ValidationService {
  public static validateShift(data: ShiftExtraction): ValidationReport {
    let score = 100;
    ...
    const hsdReadings: NozzleReading[] = [];
    const msReadings: NozzleReading[] = [];

    data.readings.forEach((r, idx) => {
      const nozzle: NozzleReading = {
        id: idx + 1,
        nozzleId: r.nozzleId,
    ...
    const report = ReconciliationEngine.reconcile(shiftRecord);
