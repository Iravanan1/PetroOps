import { ShiftExtraction } from "../../src/types/index.js";
...
export class FraudDetectionService {
  public static async analyzeShift(shiftId: string, data: ShiftExtraction): Promise<FraudAlert[]> {
    const anomalies: FraudAlert[] = [];
