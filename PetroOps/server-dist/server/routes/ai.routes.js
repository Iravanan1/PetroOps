...
exports.aiRouter.post("/structure", (0, auth_middleware_js_1.authMiddleware)(['operator', 'manager', 'owner', 'super_admin']), async (req, res) => {
    try {
...
exports.aiRouter.post("/classify", (0, auth_middleware_js_1.authMiddleware)(['manager', 'owner', 'super_admin']), async (req, res) => {
    try {
        ...
        await (0, firestore_1.addDoc)((0, firestore_1.collection)(db_js_1.db, "aiClassificationLogs"), classificationRecord);
...
exports.aiRouter.post("/reconcile", (0, auth_middleware_js_1.authMiddleware)(['operator', 'manager', 'owner', 'super_admin']), async (req, res) => {
    try {
        ...
        await (0, firestore_1.addDoc)((0, firestore_1.collection)(db_js_1.db, "reconciliationSnapshots"), snap);
...
exports.aiRouter.post("/review", (0, auth_middleware_js_1.authMiddleware)(['manager', 'owner', 'super_admin']), async (req, res) => {
    try {
        const { id, status } = req.body;
        const reviewRef = (0, firestore_1.doc)(db_js_1.db, "aiReviews", id);
        await (0, firestore_1.setDoc)(reviewRef, { status }, { merge: true });
        res.json({ success: true });
    }
    catch (error) {
        res.status(500).json({ error: error.message });
...
exports.aiRouter.get("/observability", (0, auth_middleware_js_1.authMiddleware)(['manager', 'owner', 'super_admin']), async (req, res) => {
    try {
        const snap = await (0, firestore_1.getDocs)((0, firestore_1.collection)(db_js_1.db, "ocrConfidenceLogs"));
...
exports.aiRouter.get("/dataset-index", (0, auth_middleware_js_1.authMiddleware)(['operator', 'manager', 'owner', 'super_admin']), async (req, res) => {
    try {
        const sourceDir = path_1.default.join(os_1.default.homedir(), "Pump Accounts Scans");
...
exports.aiRouter.post("/run-benchmark", (0, auth_middleware_js_1.authMiddleware)(['operator', 'manager', 'owner', 'super_admin']), async (req, res) => {
    try {
