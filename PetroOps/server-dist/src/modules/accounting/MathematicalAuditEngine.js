...
exports.MathematicalAuditEngine = void 0;
class MathematicalAuditEngine {
    /**
     * Performs rigid, deterministic mathematical audits over a shift extraction.
     * Ensures absolute ledger and physical consistency.
     */
    static auditShift(currentShift, historicalClosingCash, historicalClosingMeters, physicalDipStock, bookOpeningStock, fuelRates) {
        const discrepancies = [];
...
exports.MathematicalAuditEngine = MathematicalAuditEngine;
