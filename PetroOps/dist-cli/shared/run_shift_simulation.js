...
const ShiftStressEngine_1 = require("./ShiftStressEngine");
...
async function main() {
    ...
    const opResult = ShiftStressEngine_1.ShiftStressEngine.runStressTest('multi_day', {
        days: 5,
    ...
    const mgrResult = ShiftStressEngine_1.ShiftStressEngine.runStressTest('single', {
    ...
    const lockResult = ShiftStressEngine_1.ShiftStressEngine.runStressTest('multi_day', {
        days: 4,
